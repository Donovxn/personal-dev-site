...
export default function About() {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center gap-4 px-6 bg-black text-zinc-50">
        <h1 className="text-3xl font-semibold">About this dev site</h1>
        <p className="max-w-xl text-lg text-zinc-300 text-center">
          This site is my Phase 0 entrance exam. I&apos;m learning the basics of
